...
FROM(
            ...
            TIPO_CODIFICACION,LOGIDFROM,LOGIDTO,  to_char(DATEFROM,'YYYY-MM-DD HH24:MI:SS') DATEFROM,to_char(DATETO,'YYYY-MM-DD HH24:MI:SS')  DATETO, row_number() over (order by logIdFrom, id)  rn
